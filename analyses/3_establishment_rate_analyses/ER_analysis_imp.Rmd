...
ggsave(f1, filename = "../../figs/fig1_imp.png", width = 6, height = 4)
ggsave(f1, filename = "../../figs/fig1_imp.svg", width = 6, height = 4)
```
...
ggsave(f2, filename = "../../figs/fig2_imp.png", width = 4, height = 4)
ggsave(f2, filename = "../../figs/fig2_imp.svg", width = 4, height = 4) # remove boxes under legend
```
...
f3
# ggsave(f3, filename = "../../figs/fig3_imp.png", width = 6, height = 4.5)
```
...
f3 <- ggplot(dat,
  ...
  facet_wrap(~to_int_def)
f3
# ggsave(f3, filename = "../../figs/fig3_imp.png", width = 8, height = 4)
# ggsave(f3, filename = "../../figs/fig3_imp.svg", width = 8, height = 4)
```
...
f3 <- ggplot(datx,
  ...
  theme(panel.grid.minor = element_blank()) 
f3
ggsave(f3, filename = "../../figs/fig3_imp.png", width = 6, height = 4)
ggsave(f3, filename = "../../figs/fig3_imp.svg", width = 6, height = 4)
```
...
f4 <- ggplot(datx,
  ...
  # facet_wrap(~to_int_def)
f4
# ggsave(f4, filename = "../../figs/fig4_imp.png", width = 6, height = 4.5)
```
...
f4 <- ggplot(datx,
  ...
  facet_wrap(~to_int_def)
f4
# ggsave(f4, filename = "../../figs/fig4_imp.png", width = 8, height = 4)
# ggsave(f4, filename = "../../figs/fig4_imp.svg", width = 8, height = 4)
```
...
f4 <- ggplot(datx,
  ...
  theme(panel.grid.minor = element_blank()) 
f4
ggsave(f4, filename = "../../figs/fig4_imp.png", width = 6, height = 4)
ggsave(f4, filename = "../../figs/fig4_imp.svg", width = 6, height = 4)
```
...
f6 <- cowplot::plot_grid(f6a2, f6b2, f6c2,
                         align = "hv", nrow = 1)
ggsave(f6, filename = "../../figs/fig5_imp.png", width = 12, height = 4)
ggsave(f6, filename = "../../figs/fig5_imp.svg", width = 12, height = 4)
```

Thus, experimenters usually use higher doses in situations where lower infection rates are expected.

```{r}
save.image(file = "ER_analysis_aftermod_imp.RData")
```
