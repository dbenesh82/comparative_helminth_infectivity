...
f5a <- ggplot(dose_per_study,
  ...
  labs(x = "Host in life cycle exposed", y = "Dose",
       shape = "")
f5a
# ggsave(f5a, filename = "../../figs/fig5_uc.png", width = 4, height = 4)
# ggsave(f5a, filename = "../../figs/fig5_uc.svg", width = 4, height = 4) # remove boxes under legend
```
...
ggsave(f6, filename = "../../figs/fig5_uc.svg", width = 12, height = 4)
```
